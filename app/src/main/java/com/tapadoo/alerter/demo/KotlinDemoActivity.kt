...
import com.tapadoo.alerter.demo.databinding.ActivityDemoBinding
...
class KotlinDemoActivity : AppCompatActivity() {
    ...
    private fun showAlertWithCustomColor() {
        val alert = Alerter.create(this@KotlinDemoActivity)
    ...
    private fun showAlertWithCustomLayout() {
        Alerter.create(this@KotlinDemoActivity, R.layout.custom_layout)
            .setBackgroundColorRes(R.color.colorAccent)
            .also { alerter ->
                val view = alerter.getLayoutContainer() ?: return
                view.findViewById<TextView>(R.id.tvCustomLayout)
                    ?.setText(R.string.with_custom_layout)
            }
            .show()
    }
            ...
            btnBottomSheetModal.setOnClickListener {
                CustomBottomSheetDialogFragment().apply {
                    show(
                        ...
                        CustomBottomSheetDialogFragment::class.java.canonicalName
                    )
                }
            }
        }
